...
public class ProgramaPrincipal {
	...
	public static boolean cadastraProfessor(Scanner teclado, Professor[] professores) {
		...
		System.out.println("Digite o nÃºmero de registro do professor: ");
	...
	public static void main(String[] args) {
		...
		// Aumentar o salÃ¡rio de um funcionÃ¡rio pelo seu cpf
		...
		// Inicializando os arrays que servirÃ£o como controle.
